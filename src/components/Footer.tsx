...
export default function Footer() {
  return (
    <footer className="bg-[#1B1F2A]/50 text-[#D0D5E6] mt-auto border-t border-[#2a2f3e]/50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-[#D0D5E6]/60 max-w-xs">
              CursosPro — Compare. Escolha. Aprenda.
            </p>
            <p className="text-xs text-[#D0D5E6]/40 mt-3 max-w-xs">
              Encontre os melhores cursos online com desconto das principais plataformas digitais.
            </p>
          </div>

          <div>
            <h3 className="text-white font-bold mb-4 text-sm uppercase tracking-wider">Navegacao</h3>
          ...
          <div>
            <h3 className="text-white font-bold mb-4 text-sm uppercase tracking-wider">Categorias</h3>
            <ul className="space-y-2.5 text-sm">
              <li>
        ...
        <div className="border-t border-[#2a2f3e]/50 mt-10 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-xs text-[#D0D5E6]/50">
              &copy; {new Date().getFullYear()} CursosPro. Todos os direitos reservados.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-xs text-[#D0D5E6]/40">
              ...
              <span className="text-[#D0D5E6]/20">|</span>
